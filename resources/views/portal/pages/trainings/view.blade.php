    ...
    @endif
            ...
            <div class="w-full flex items-center justify-start gap-1">
                ...
                <h1 class="font-bold text-gray-600 text-[1.5rem]">Training Details</h1>
                    ...
                    <form action="{{route('portal.training.resubmit', ['id'=> $data->id])}}" method = "POST">
                        @csrf 
                        @method('PATCH')
                    ...
                    <span class="text-gray-400 text-xs pl-4 flex flex-col w-2/6"><strong> Important Notice </strong> 
                    Please ensure that all changes are thoroughly reviewed and edited before resubmitting your request.</span>
                    @endif
